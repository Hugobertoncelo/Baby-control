...
export default function FamilySelectPage() {
  ...
  const [selectedFamily, setSelectedFamily] = useState<FamilyResponse | null>(
    null
  );
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    switch (e.key) {
      ...
      case "Enter":
        ...
        if (
          highlightedIndex >= 0 &&
          highlightedIndex < filteredFamilies.length
        ) {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-white family-select-container">
        <div className="text-center">
          ...
          <p className="text-gray-500 family-select-loading-text">
            Carregando famílias...
          </p>
        </div>
      </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white family-select-container">
      <div className="w-full max-w-md mx-auto p-6">
        <div className="text-center mt-2 mb-4">
          <h2 className="text-xl font-semibold family-select-title">
            Bem-vindo ao Baby Control
          </h2>
          <p className="text-sm text-gray-500 family-select-description">
            Selecione sua família para continuar e fazer login.
          </p>
        </div>
          ...
          <div className="w-full max-w-[320px] space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-2 text-teal-600 mb-4">
                ...
                <span className="text-lg font-semibold family-select-section-title">
                  Seleção de Família
                </span>
              </div>
                ...
                <div className="relative w-full">
                  <div className="flex items-center w-full">
                    ...
                    <Input
                      ...
                      placeholder="Procure sua família..."
                      disabled={loading}
                    />
                    <ChevronDown
          ...
          <div className="w-full max-w-[320px]">
            ...
            >
              <span className="flex items-center justify-center space-x-2">
                <span>Continuar para fazer login</span>
