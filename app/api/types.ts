import {
  ...
  Medicine,
  MedicineLog,
  EmailConfig as PrismaEmailConfig,
  EmailProviderType,
} from "@prisma/client";
...
export type SleepLogResponse = Omit<
  SleepLog,
...
export type FeedLogResponse = Omit<
  FeedLog,
  "time" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  time: string;
  createdAt: string;
  updatedAt: string;
...
export type DiaperLogResponse = Omit<
  DiaperLog,
  "time" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  time: string;
...
export type MoodLogResponse = Omit<
  MoodLog,
  "time" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  time: string;
...
export type CaretakerResponse = Omit<
  Caretaker,
...
export type EmailConfigResponse = Omit<
  PrismaEmailConfig,
  "updatedAt" | "password"
> & {
  updatedAt: string;
...
export interface EmailConfigUpdate
  extends Partial<Omit<PrismaEmailConfig, "id" | "updatedAt">> {}
...
export type BathLogResponse = Omit<
  BathLog,
  "time" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  time: string;
...
export type PumpLogResponse = Omit<
  PumpLog,
  "startTime" | "endTime" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  startTime: string;
...
export type MilestoneResponse = Omit<
  Milestone,
...
export type MeasurementResponse = Omit<
  Measurement,
  "date" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  date: string;
...
export type MedicineResponse = Omit<
  Medicine,
  "createdAt" | "updatedAt" | "deletedAt"
> & {
  createdAt: string;
...
export type MedicineLogResponse = Omit<
  MedicineLog,
  "time" | "createdAt" | "updatedAt" | "deletedAt"
> & {
  time: string;
