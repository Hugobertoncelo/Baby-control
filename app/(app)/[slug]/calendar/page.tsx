          ...
          {isCheckingAccountStatus ? (
            ...
            <div className="flex flex-col items-center justify-center h-[calc(100vh-192px)] text-center bg-white border-t border-gray-200">
              ...
              <p className="text-sm text-gray-500 mb-4">
                ...
                sua família antes de visualizar as atividades do calendário.
              </p>
              <button
            ...
            <NoBabySelected
              title="Escolha um bebê"
              description="Selecione um bebê para visualizar as atividades do calendário."
            />
          )}
        </div>
      )}
