...
function FullLogPage() {
  ...
  const refreshActivities = useCallback(async () => {
    ...
    try {
      ...
      let url = `/api/timeline?babyId=${
        selectedBaby.id
      }&startDate=${adjustedStartDate.toISOString()}&endDate=${adjustedEndDate.toISOString()}&timezone=${encodeURIComponent(
        userTimezone
      )}`;
          ...
          {isCheckingAccountStatus ? (
            ...
            <div className="flex flex-col items-center justify-center h-[calc(100vh-192px)] text-center bg-white border-t border-gray-200">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Welcome {accountStatus.firstName}! You need to set up your
                family before you can view activity logs.
              </p>
              <button
            ...
            <NoBabySelected
              ...
              description="Escolha um bebê para visualizar o histórico completo de atividades."
            />
          )}
        </div>
      )}
