...
async function setFamilyStatusMenu() {
  ...
  console.log('1. Trial Active (14 Dias from now)');
  console.log('2. Trial Expired (2 Dias ago)');
  console.log('3. Subscription Active (30 Dias from now)');
  console.log('4. Subscription Expired (2 Dias ago)');
