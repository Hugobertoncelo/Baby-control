...
RUN mkdir -p /app/env && \
    ...
    echo "DATABASE_URL=\"file:/db/baby-control.db\"" >> /app/env/.env && \
    echo "LOG_DATABASE_URL=\"file:/db/baby-control-logs.db\"" >> /app/env/.env && \
    ...
    [ -e /app/.env ] && rm /app/.env; ln -s /app/env/.env /app/.env
