export const backupRestoreStyles = {
  ...
  error: {
    container:
      "p-3 bg-red-50 border border-red-200 rounded-md backup-restore-error-container",
  ...
  success: {
    container:
      "p-3 bg-green-50 border border-green-200 rounded-md backup-restore-success-container",
    content: "flex items-center",
