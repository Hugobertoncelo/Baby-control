export const medicineFormStyles = {
  ...
  tabButton:
    "px-4 py-2 text-sm font-medium text-gray-600 hover:text-teal-600 focus:outline-none",
  ...
  medicineItem:
    "p-3 bg-white border border-gray-200 rounded-lg flex justify-between items-center",
  ...
  iconContainer:
    "flex items-center justify-center w-8 h-8 rounded-full bg-teal-100 text-teal-600",
