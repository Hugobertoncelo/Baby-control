...
export const privacyPolicyModalStyles = {
  ...
  closeButton:
    "bg-gradient-to-r from-teal-600 to-emerald-600 text-white hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200",
};
