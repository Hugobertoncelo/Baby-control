      ...
      <DialogContent className="dialog-content !p-4 sm:!p-6">
        <DialogHeader className="dialog-header">
          <DialogTitle className="dialog-title">
            {activity ? "Editar Alimentação" : "Registrar Alimentação"}
          </DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="SOLIDS">Comida Sólida</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          {(formData.type === "BOTTLE" || formData.type === "SOLIDS") && (
            <div>
              <label className="form-label">
                Quantidade {formData.type === "SOLIDS" ? "(g)" : "(oz)"}
              </label>
          ...
          {formData.type === "SOLIDS" && (
            <div>
              ...
              >
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Selecione a comida" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="BANANA">Banana</SelectItem>
                  <SelectItem value="RICE_CEREAL">Cereal de Arroz</SelectItem>
                  <SelectItem value="PUREE">Purê</SelectItem>
          ...
          <div className="grid grid-cols-2 sm:flex sm:justify-end gap-3 mt-6">
            ...
            >
              {activity ? "Atualizar Alimentação" : "Salvar Alimentação"}
            </Button>
          </div>
        </form>
      </DialogContent>
