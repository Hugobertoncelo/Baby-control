      ...
      <DialogContent className="dialog-content !p-4 sm:!p-6">
        <DialogHeader className="dialog-header">
          <DialogTitle className="dialog-title">
            {activity ? "Editar Nota" : "Adicionar Nota"}
          </DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-3">
                  ...
                  <Input
                    ...
                    onKeyDown={(e) => {
                      ...
                      if (e.key === "ArrowDown") {
                        ...
                        setFormData({
                          ...formData,
                          category: visibleCategories[selectedIndex],
                        });
                        setShowDropdown(false);
            ...
            <div>
              <label className="form-label">Conteúdo da Nota</label>
              <Textarea
          ...
          <div className="grid grid-cols-2 sm:flex sm:justify-end gap-3 mt-6">
            ...
            >
              {activity ? "Atualizar Nota" : "Salvar Nota"}
            </Button>
          </div>
        </form>
      </DialogContent>
