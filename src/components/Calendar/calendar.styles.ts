export const calendarStyles = {
  ...
  header:
    "flex items-center justify-between p-2 bg-gradient-to-r from-teal-600 to-teal-700 text-white border-t border-gray-200 dark:border-gray-700",
  headerTitle: "text-lg font-semibold",
  headerButton: "text-white hover:bg-teal-500/20",
  todayButton:
    "text-xs text-white/80 hover:text-white hover:bg-teal-500/20 py-0 h-6",
  ...
  weekdaysHeader:
    "grid grid-cols-7 text-center bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700",
  weekdayCell: "py-2 text-xs font-medium text-gray-500 dark:text-gray-400",
  daysGrid: "grid grid-cols-7 h-[calc(100%-32px)]",
  dayCell:
    "flex flex-col h-full min-h-[60px] p-1 border border-gray-200 dark:border-gray-700 cursor-pointer",
  dayCellToday:
