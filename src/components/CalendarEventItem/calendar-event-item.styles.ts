export const calendarEventItemStyles = {
  container:
    "flex items-center p-3 rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer calendar-event-item-container",
  colorIndicator: {
  ...
  details:
    "flex items-center mt-1 text-xs text-gray-600 calendar-event-item-details",
  icon: {
  ...
  badgeCount:
    "ml-1 text-xs font-medium text-gray-600 calendar-event-item-badge-count",
} as const;
