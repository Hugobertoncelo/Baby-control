...
export const sideNavStyles = {
  container:
    "fixed inset-y-0 left-0 z-50 flex flex-col bg-white transform transition-all duration-300 ease-in-out w-64",

  containerNonModal:
    "flex flex-col bg-white w-64 min-h-screen h-full transition-all duration-300 ease-in-out",
  ...
  navItem:
    "flex items-center w-full px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-700 transition-colors duration-200 rounded-lg mb-2",
