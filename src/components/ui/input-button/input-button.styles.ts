...
export const inputButtonVariants = cva("relative flex items-center", {
  variants: {
    layout: {
      left: "flex-row",
      right: "flex-row",
...
export const inputButtonButtonStyles = {
  ...
  variants: {
    default:
      "bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-teal-600",
    destructive:
      "bg-gradient-to-r from-red-600 to-rose-600 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-red-600",
    outline:
      "border-2 border-slate-200 bg-white hover:border-teal-300 hover:bg-teal-50 text-teal-700",
    secondary:
      "bg-gradient-to-r from-slate-700 to-slate-800 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-slate-700",
    ...
    success:
      "bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-emerald-500",
    info: "bg-gradient-to-r from-sky-500 to-blue-600 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-sky-500",
    warning:
      "bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 border-amber-500",
  },
  sizes: {
