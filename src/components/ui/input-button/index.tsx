  ...
  (
    ...
    const buttonDarkClass =
      buttonVariant === "outline"
        ? "input-button-button-dark-outline"
        : buttonVariant === "ghost"
        ? "input-button-button-dark-ghost"
        : buttonVariant === "link"
        ? "input-button-button-dark-link"
        : buttonVariant === "secondary"
        ? "input-button-button-dark-secondary"
        : "";
    ...
    const getButtonStyles = () => {
      ...
      if (buttonVariant && buttonVariant in inputButtonButtonStyles.variants) {
        baseStyles.push(
          inputButtonButtonStyles.variants[
            buttonVariant as keyof typeof inputButtonButtonStyles.variants
          ]
        );
      }
      ...
      if (buttonSize && buttonSize in inputButtonButtonStyles.sizes) {
        baseStyles.push(
          inputButtonButtonStyles.sizes[
            buttonSize as keyof typeof inputButtonButtonStyles.sizes
          ]
        );
      }
    ...
    const inputElement = (
      <input
        ref={ref}
        className={cn(getInputStyles(), inputDarkClass, inputClassName)}
        {...props}
      />
    );
    ...
    const buttonElement = (
      <button
        ...
        className={cn(getButtonStyles(), buttonDarkClass, buttonClassName)}
      >
        {buttonLoading ? (
