export const tableStyles = {
  table:
    "w-full caption-bottom text-sm border-separate border-spacing-0 rounded-xl overflow-hidden border border-gray-200 bg-white/80 backdrop-blur-sm transition-all duration-200 hover:bg-white/90",
  ...
  footer:
    "[&_tr]:border-t [&_tr]:border-gray-200 bg-gray-50/80 backdrop-blur-sm",
  ...
  paginationContainer:
    "mt-2 flex flex-col sm:flex-row items-center justify-between gap-4 px-2",
  ...
  tabBadge:
    "ml-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-gray-200 text-xs font-medium text-gray-700",
  tabBadgeActive:
    "ml-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-teal-100 text-xs font-medium text-teal-700",
} as const;
