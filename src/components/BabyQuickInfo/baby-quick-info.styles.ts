...
export const styles = {
  ...
  tabContainer:
    "flex flex-row border-b border-gray-200 mb-4 md:justify-start overflow-x-auto",
  tabButton:
    "py-2 px-4 text-sm font-medium text-gray-700 hover:bg-teal-50 hover:text-teal-700 transition-colors duration-200 focus:outline-none",
  tabButtonActive:
  ...
  activityItem:
    "flex items-start p-2 rounded-lg bg-gray-50 border border-gray-100 shadow-sm mb-1 last:mb-0",
  activityIconContainer:
    "flex-shrink-0 p-1.5 mr-2 rounded-full bg-teal-100 text-teal-600",
  ...
  contactItem:
    "flex items-start p-3 rounded-lg bg-gray-50 border border-gray-100 shadow-sm mb-2 last:mb-0",
  contactInfo: "flex-1",
  ...
  eventItem:
    "p-3 rounded-lg bg-gray-50 border border-gray-100 shadow-sm border-l-4",
