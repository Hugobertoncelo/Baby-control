export const styles = {
  container:
    "min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-teal-50 to-white",
  ...
  stageImage: "mx-auto mb-6 drop-shadow-[0_3px_3px_rgba(0,0,0,0.7)]",
  formGroup: "space-y-4",
  ...
  errorContainer:
    "mt-4 p-2 bg-red-50 border border-red-200 rounded text-red-600 text-sm",
  navigationContainer: "flex justify-between mt-8",
  previousButton:
    "px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500",
  nextButton:
    "px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500",
};
