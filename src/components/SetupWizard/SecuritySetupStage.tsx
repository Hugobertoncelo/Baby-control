    ...
    <div className={cn(styles.stageContainer, "setup-wizard-stage-container")}>
      ...
      {isAccountAuth && !accountOwnerAdded && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
          <p className="text-blue-800 text-sm">
            Choose a simple shared PIN or create personal login credentials with
            better tracking.
          </p>
        </div>
      )}
      ...
      >
        ...
        >
          ...
          >
            {isAccountAuth
              ? "Create personal login credentials"
        ...
        >
          <div className={cn(styles.formGroup, "setup-wizard-form-group")}>
            ...
            <Input
              ...
              placeholder={
                isAccountAuth ? "Enter system-wide PIN" : "Enter PIN"
              }
          ...
          <div className={cn(styles.formGroup, "setup-wizard-form-group")}>
            ...
            <Input
              ...
              placeholder={
                isAccountAuth ? "Confirm system-wide PIN" : "Confirm PIN"
              }
              className={cn(styles.formInput, "setup-wizard-form-input")}
              minLength={6}
              maxLength={10}
          ...
          >
            ...
            >
              {isAccountAuth && !accountOwnerAdded
                ...
                : isAccountAuth && accountOwnerAdded
                ? "Add Additional Caretaker"
                : "Add Caretaker"}
            </h3>
            {isAccountAuth && !accountOwnerAdded && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                <p className="text-green-800 text-sm">
                  Create your personal login credentials. Choose a 2-digit ID
                  and set your PIN.
                </p>
              </div>
            )}
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Input
                    ...
                    placeholder={
                      isAccountAuth ? "Enter 2-digit ID" : "e.g., 01, 12, 99"
                    }
                    className={cn(
                      styles.formInput,
            ...
            >
              <div>
                ...
                >
                  {isAccountAuth && !accountOwnerAdded
                    ? "Your Personal PIN (6-10 digits)"
                    : isAccountAuth && accountOwnerAdded
                    ? "New Caretaker PIN (6-10 digits)"
                    : "PIN (6-10 digits)"}
                </label>
                <Input
                  id="securityPin"
