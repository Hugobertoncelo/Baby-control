export const dailyStatsStyles = {
  ...
  header:
    "flex items-center justify-between p-3 border-b border-gray-200 daily-stats-header",
  date: "text-sm font-medium text-gray-700",
  content: "grid grid-cols-2 gap-4 p-4 md:grid-cols-5 daily-stats-content",
  empty:
    "col-span-2 md:col-span-5 py-4 text-center text-gray-500 daily-stats-empty",
  ...
  statItem: {
    ...
    iconContainer:
      "flex-shrink-0 p-2 rounded-xl bg-gray-100 daily-stats-item-bg",
