export const calendarEventStyles = {
  container:
    "flex flex-col rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200 border-l-4 calendar-event-container",
  header:
    "flex justify-between items-center p-4 bg-gray-50 border-b border-gray-200 calendar-event-header",
  ...
  description:
    "mt-3 pt-3 border-t border-gray-200 text-sm text-gray-700 whitespace-pre-line calendar-event-description",
  actions:
    "flex justify-end space-x-2 p-3 bg-gray-50 border-t border-gray-200 calendar-event-actions",
  actionButton:
    "px-3 py-1 text-xs font-medium rounded-md calendar-event-action-button",
